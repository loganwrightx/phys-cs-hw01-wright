...
According to the laws of physics, a nice optimization may be made by using Newton's Third Law–every interaction is equal and opposite the reaction experienced by the other mass in space. In a future development, this would reduce time complexity from $O(N^2)$ to $\sum_{k=0}^{k=N} (N-k-1)$.
